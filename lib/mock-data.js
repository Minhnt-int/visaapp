...
const siteConfig = {
  name: "Kim Quy Travel",
  description: "Dịch vụ làm visa chuyên nghiệp, nhanh chóng và tin cậy. Kim Quy Travel cung cấp các giải pháp toàn diện cho visa du lịch, công tác, và thăm thân với tỷ lệ thành công cao.",
  url: "https://kimquytravel.vn", // Replace with your actual domain
  ogImage: "https://kimquytravel.vn/og-image.jpg", // Replace with your actual OG image URL
};

const contactInfo = {
  address: "Tầng 5, toà nhà APTEK, 77-79-81 Nguyễn Văn Linh, phường Nam Dương, quận Hải Châu, TP. Đà Nẵng",
  phone: "0911.909.686",
  email: "info@Kim Quy Travel.com",
  website: "www.Kim Quy Travel.com",
  facebook: "https://facebook.com/Kim Quy Travel",
...
const navigationLinks = [
    ...
    { 
        ...
        children: [
            ...
            { label: "Visa Châu Phi", href: "/dich-vu/visa-chau-phi" },
